...
import com.lukasz.quizapp.repositories.RefreshTokenRepository;
...
public class RefreshTokenService {
    ...
    public RefreshToken createRefreshToken(Long userId) {
        ...
        refreshToken.setUser(userService.read(userId));
    ...
    public int deleteByUserId(Long userId) {
        return refreshTokenRepository.deleteByUser(userService.read(userId));
    }
}
